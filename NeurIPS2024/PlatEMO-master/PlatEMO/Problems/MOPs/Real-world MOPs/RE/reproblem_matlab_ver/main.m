...
fprintf("The selected probelm is %s\n", testProblem);
fprintf("Number of objectives = %d, number of design variables = %d, number of constraints = %d \n", numObjs, numVars, numConsts);
fprintf("Lower bounds for x: ");
disp(lowerBounds)
fprintf("Upper bounds for x: ");
disp(upperBounds)
fprintf("Randomly generated solution x: ");
...
fprintf("Objective vector of  x: ");
disp(res)

if numConsts > 0
   fprintf("Constraint violation values of  x: ");
   disp(g)
end
